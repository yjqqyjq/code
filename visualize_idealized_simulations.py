...
ax.set_ylabel("S")
fig.savefig("/home/jyang/plot/idealizedsim/"+para+"/S.png")
'''
for i in range(0,10):
...
#  y=np.append(y_dm[i],y_g[i])
  ...
  if i*10<10:
    fig.savefig('/home/jyang/plot/idealizedsim/'+para+'/xydm0'+str(i)+'0.png')
  else:

    fig.savefig('/home/jyang/plot/idealizedsim/'+para+'/xydm'+str(i)+'0.png')
  plt.close(fig)
...
#  y=np.append(y_dm[i],y_g[i])
  ...
  plt.colorbar(h[3], ax=ax)
  if i*10<10:
    fig.savefig('/home/jyang/plot/idealizedsim/'+para+'/xyg0'+str(i)+'0.png')
  else:

    fig.savefig('/home/jyang/plot/idealizedsim/'+para+'/xyg'+str(i)+'0.png')
  plt.close(fig)